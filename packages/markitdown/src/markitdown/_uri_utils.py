...
def parse_data_uri(uri: str) -> Tuple[str | None, Dict[str, str], bytes]:
    ...
    None if not specified, attributes is a dict of any key=value (or bare
    key) pairs found in the metadata section, and content is the decoded
    (base64 or percent-encoded) payload bytes.
    """
